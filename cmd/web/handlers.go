...
func (app *application) defaultRouteHandler(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, r, "home.tmpl.html", data, http.StatusOK)
}
...
func (app *application) snippetView(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, r, "view-snippet.tmpl.html", data, http.StatusOK)
}
...
func (app *application) snippetCreate(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365), "expires", "Invalid value for expire field")

	if !form.Valid() {
		app.render(w, r, "create-snippet.tmpl.html", templateData{Form: form}, http.StatusUnprocessableEntity)
		return
	}
...
func (app *application) snippetCreateForm(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, r, "create-snippet.tmpl.html", data, http.StatusOK)
}
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Password), "email", "This field cannot be empty")
